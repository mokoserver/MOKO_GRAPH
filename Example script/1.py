...
i = 0
while i < 200:
    noise.append(random.uniform(-118,-100))
    array.append(2.4248+(2.434-2.4248)/200*i)
    i = i + 1

i = 0
while i < 200:
    noise.append(random.uniform(-120,-106))
